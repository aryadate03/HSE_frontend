...
import { Mail, Phone, Building, BadgeCheck, ShieldCheck } from 'lucide-react';
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            style={{ borderColor: '#3b82f6', color: '#3b82f6', background: editing ? '#eff6ff' : 'white' }}
          >
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            style={{ borderColor: '#3b82f6', color: '#3b82f6', background: showPasswordSection ? '#eff6ff' : 'white' }}
          >
          ...
          <form onSubmit={handlePasswordSave} className="mt-4 space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none bg-gray-50 ${pwErrors.currentPassword ? 'border-red-400' : 'border-gray-200 focus:border-blue-400'}`}
                placeholder="••••••••"
              />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none bg-gray-50 ${pwErrors.newPassword ? 'border-red-400' : 'border-gray-200 focus:border-blue-400'}`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none bg-gray-50 ${pwErrors.confirmPassword ? 'border-red-400' : 'border-gray-200 focus:border-blue-400'}`}
        ...
        <div className="space-y-1">
          {[
            ...
            <div key={label} className="flex justify-between items-center py-2" style={{ borderBottom: '1px solid #f3f4f6' }}>
              ...
              <span className={`text-xs font-medium ${green ? 'text-green-600' : 'text-gray-700'} ${mono ? 'font-mono' : 'capitalize'}`}>
                {value}
              </span>
            </div>
          ))}
